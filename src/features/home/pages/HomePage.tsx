  ...
  return(
    <div className="flex flex-col">
      ...
      <section className="flex flex-col-reverse md:flex-row items-stretch">
        ...
        <div className="flex-1 p-8 md:p-16 text-center md:text-left bg-secondary-100 flex flex-col justify-center">
          <h1 className="headline-L-bold  font-bold mb-4 text-gray-900">
            Esta noche, alguien dormirá aquí
          </h1>
          <p className="text-gray-600 text-L-regular mb-6">
      ...
      <section className="py-16 px-6 bg-basics-100 text-center">
        <h2 className="text-XL-bold text-3xl font-bold mb-10 text-gray-900">
          La dura realidad:
        </h2>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-5xl mx-auto text-L-bold">
    ...
    <section className="py-16 px-6 md:px-16 bg-secondary-100 flex flex-col items-center gap-10">
      ...
      <div className="max-w-2xl text-center flex flex-col items-center ">
        <h2 className="text-2xl md:text-3xl font-bold mb-4 text-basics-900 text-L-bold">
          Qué hacemos desde Calor en la Noche
        </h2>
        <p className="text-basics-700 mb-6 leading-relaxed text-M-regular">
      ...
      {/* Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-10 max-w-5xl w-full text-L-bold">
        <HomeCard
